/*
 * ================================================================
 * INVENTORY MANAGEMENT SYSTEM (WITH ROBUST INPUT VALIDATION)
 * ================================================================
 */
...
#include <string>
#include <ctime>
#include <algorithm> // Used for trim and search algorithms
...
// Helper to check if string contains only spaces or is completely empty
...
// ================================================================
// ABSTRACT BASE CLASS: Product (Abstraction & Encapsulation)
// ================================================================
class Product {
private:
    int id;
...
// ================================================================
// DERIVED CLASS 2: NonPerishableProduct
// ================================================================
...
// ================================================================
// INVENTORY MANAGER CLASS (Arrays of Objects & Dynamic Memory)
// ================================================================
class Inventory {
private:
...
// ================================================================
// MAIN FUNCTION (Console Menu Loop with Sub-Menus)
// ================================================================
int main() {
    Inventory inv;
    ...
    while (true) {
        ...
        try {
            if (choice == 1) {
                ...
                // Normal execution flow if ID is brand new
                double qty;
                int type, unitChoice;
